...
const NAV_ITEMS = [
  ...
  { icon: 'users',     label: '직원 연차 현황', href: 'employees.html' },
  { icon: 'cal-check', label: '휴가 신청 관리', href: 'requests.html' },
  { icon: 'calendar',  label: '연차 캘린더',    href: 'calendar.html' },
  { icon: 'bar-chart', label: '보고서',         href: 'reports.html' },
];
...
function initLayout(currentHref) {
  ...
  el.innerHTML = `
    <div class="sidebar-logo">
      <div>
        <span class="sidebar-brand">LeaveERP</span>
        <span class="sidebar-tagline">휴가 관리 시스템</span>
      </div>
    </div>
